...
pub fn create_sampler_from_config(cfg: &dd_trace::Config) -> DatadogSampler {
...
fn create_default_sampler(cfg: &dd_trace::Config) -> DatadogSampler {
    DatadogSampler::new(None, cfg.trace_rate_limit().map(|r| r as i32))
}
