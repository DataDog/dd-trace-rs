...
pub(crate) const TRACE_ID_KEY: &str = "x-datadog-trace-id";
pub(crate) const PARENT_ID_KEY: &str = "x-datadog-parent-id";
pub(crate) const SAMPLING_PRIORITY_KEY: &str = "x-datadog-sampling-priority";
pub(crate) const TAGS_KEY: &str = "x-datadog-tags";
