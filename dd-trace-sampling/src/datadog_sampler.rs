...
impl DatadogSampler {
    ...
    pub fn new(
        ...
        // if the resource is empty set to a default empty resource
...
mod tests {
    ...
    fn test_sampling_rule_with_no_rule() {
        ...
        assert!(rule_with_empty_strings.matches(attributes.as_slice(), &SpanKind::Client, &empty_resource));
    }
    ...
    fn test_sampling_rule_matches() {
        ...
        assert!(rule.matches(&matching_attributes, &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(!rule.matches(&wrong_service, &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(!rule.matches(&wrong_name_attributes, &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(!rule.matches(&wrong_tag_value, &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(!rule.matches(&wrong_tag_key, &SpanKind::Client, &create_empty_resource()));
    }
    ...
    fn test_datadog_sampler_creation() {
        ...
        let sampler_with_rules = DatadogSampler::new(Some(vec![rule]), Some(200), create_empty_resource());
    ...
    fn test_find_matching_rule() {
        ...
        let sampler = DatadogSampler::new(Some(vec![rule1, rule2, rule3]), None, create_empty_resource());
    ...
    fn test_sampling_rule_matches_float_attributes() {
        ...
        assert!(rule_integer.matches(integer_float_attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(rule_wildcard.matches(decimal_float_attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
        ...
        let decimal_float_attrs = create_attributes_with_float("service", "float_tag", 42.5);
        assert!(!rule_specific.matches(decimal_float_attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(!rule_prefix.matches(decimal_float_attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
    }
    ...
    fn test_otel_to_datadog_attribute_mapping() {
        ...
        assert!(rule.matches(otel_attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(rule.matches(dd_attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(!rule.matches(non_matching_attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(!rule.matches(unrelated_attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
    }
    ...
    fn test_multiple_otel_attribute_mappings() {
        ...
        assert!(rule.matches(mixed_attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(!rule.matches(missing_method.as_slice(), &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(!rule.matches(wrong_method.as_slice(), &SpanKind::Client, &create_empty_resource()));
    }
    ...
    fn test_direct_and_mapped_mixed_attributes() {
        ...
        assert!(!rule.matches(missing_custom.as_slice(), &SpanKind::Client, &create_empty_resource()));
    }
    ...
    fn test_sampling_rule_with_various_attribute_types() {
        ...
        assert!(rule.matches(attrs.as_slice(), &SpanKind::Client, &create_empty_resource()));
        ...
        assert!(wildcard_rule.matches(wildcard_float.as_slice(), &SpanKind::Client, &create_empty_resource()));
    }
    ...
    fn test_operation_name_integration() {
        ...
        let sampler = DatadogSampler::new(Some(vec![http_rule, db_rule, messaging_rule]), None, create_empty_resource());
